            ...
            <div className='product-detail-body'>
                <div className='product-detail'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-6'>
                            <img className='img-product' src={require(`../../asset/images-product/${product.image}`)} />
                        </div>
                        <div className='col-6 content-detail'>
                            ...
                            <a href="#" class="btn btn-success btn-cart-detail">Thêm vào giỏ hàng   </a>
                        </div>
                    </div>
                    ...
                    <div className='content-comment'>
                        ...
                        <div className='row'>
                            <div className='col-2 avt'>
                                <img className='img-avt' src={require('../../asset/Images/plant.png')} />
                            </div>
